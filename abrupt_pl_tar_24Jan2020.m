...
exp_param.discrim_dist = [-1, 0, 1]; % changed
...
nC_nFB = 5; % no FB trials 

nC_abrupt = 10; % can also be taken out and replace with baseline trails 
...
raw_events = repmat(1:260, 1, 8)';

T.covert = zeros(nT_total, 1);
% counterbalanced
switch exp_param.ver
    case 1
        T.covert(Trial.Discrim(1):Trial.Discrim(1) + exp_param.discrim_len - 1) = 1;
    case 2
        T.covert(Trial.Discrim(1) + exp_param.discrim_len:Trial.Discrim(2)) = 1;
end
        ...
        case 45
            switch T.discrim_dist(ti)
                case 0
                    T.discrim_tar(ti) = 45; 
                case 1
                    T.discrim_tar(ti) = 15; % Is this correct? 
                case -1
                    T.discrim_tar(ti) = 75; 
            end
        case 135
