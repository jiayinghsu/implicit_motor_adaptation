 function run_abrupt_pl(hUDP)
 %function run_abrupt_pl()
%------------------------
% INPUT TARGET FILE
%------------------------
...
while trial <= maxtrialnum   %
   ...
   if InExpSystem
    ...
    if trial == 1 % calibrate eye tracker
    ...
    elseif gamephase == 1 
        ...
        draw_arrow(window, [xCenter, yCenter], - tgt_location(trial) - 180, [1, 1, 1], [25, 10, 0, 0]); % 0 is pointing left, 180 is pointing right
    ...
    elseif gamephase == 2  % Moving toward targets
