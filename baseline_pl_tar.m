...
exp_param.target_location = [45, 135, 225, 315]; % changed into 45, 135, 225, 315
exp_param.discrim_onset = [150, 200, 250, 300] / 1000; % need 2 before movement and 2 after. 
exp_param.tgt_reps = [10, 10, 10, 10];
...
nT_total = (nC_FB + nC_nFB + nC_Discrim) * exp_param.num_target; % Total number of trials
...
Trial.Discrim(1) = Trial.nFB(2) + 1;
Trial.Discrim(2) = Trial.nFB(2) + nC_Discrim * exp_param.num_target; % block 4
